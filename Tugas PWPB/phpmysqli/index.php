...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nis && $nama && $alamat && $jurusan) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update mahasiswa set nis = '$nis',nama='$nama',alamat = '$alamat',jurusan='$jurusan' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into mahasiswa(nis,nama,alamat,jurusan) values ('$nis','$nama','$alamat','$jurusan')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="jurusan" id="jurusan">
                                ...
                                <option value="MM" <?php if ($jurusan == "MM") echo "selected" ?>>MM</option>
